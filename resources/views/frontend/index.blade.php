            ...
            <ul class="glide__slides">
                <li class="glide__slide">
                    <div class="center">
                        ...
                        <div class="right">
                            <img class="img1" src="{{ asset('front/assets/images/hero-1.png') }}" alt="">
                        </div>
                    </div>
                </li>
                <li class="glide__slide">
                    <div class="center">
                        ...
                        <div class="right">
                            <img class="img2" src="{{ asset('front/assets/images/hero-2.png') }}" alt="">
                        </div>
                    </div>
                </li>
            </ul>
...
<section class="section category">
    <div class="cat-center">
        <div class="cat">
            <img src="{{ asset('front/assets/images/cat1.jpg') }}" alt="" />
            <div>
                <p>WOMEN'S WEAR</p>
            </div>
        </div>
        <div class="cat">
            <img src="{{ asset('front/assets/images/cat2.jpg') }}" alt="" />
            <div>
                <p>ACCESSORIES</p>
            </div>
        </div>
        <div class="cat">
            <img src="{{ asset('front/assets/images/cat3.jpg') }}" alt="" />
            <div>
                <p>MEN'S WEAR</p>
            </div>
        </div>
