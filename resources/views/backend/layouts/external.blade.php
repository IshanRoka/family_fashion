...
<style>
    ...
    .custom-login {
        ...
        width: 100%;
        height: 100vh;
        /* background: linear-gradient(to right, rgb(18 42 56 / 60%), rgba(18, 42, 56, 1)), url(/images/people-collage-design.png); */
        /* background: linear-gradient(rgb(18 42 56 / 60%), rgba(18, 42, 56, 1)), url(/images/people-collage-design.png); */
